import { getUnanalyzedNews, getNeedsDeepAnalysis, getHighSignalNews, insertAnalysis, updateDeepAnalysis } from './db.js';
...
async function callDeepAnalysis(newsItems) {
  ...
  return parseAnalysisResponse(content, newsItems); // reuse parser
}
